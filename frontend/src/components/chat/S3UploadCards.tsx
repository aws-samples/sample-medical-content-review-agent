    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
      ...
      <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
        ...
        <div className="p-4">
          ...
          />
          <p className="text-[10px] text-muted-foreground mt-2">The medical content PDF to review</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
        ...
        <div className="p-4">
          ...
          />
          <p className="text-[10px] text-muted-foreground mt-2">Source documents to verify claims against</p>
        </div>
      </div>
      ...
      <div className="bg-card rounded-2xl shadow-lg border border-border overflow-hidden">
        ...
        <div className="p-4">
          ...
          />
          <p className="text-[10px] text-muted-foreground mt-2">Pre-approved claims to check adherence against</p>
        </div>
      </div>
    </div>
  );
